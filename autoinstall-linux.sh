...
echo "Bắt đầu cập nhật các gói dữ liệu từ máy chủ của hệ điều hành..."
apt update && apt upgrade -y
clear
echo "Bắt đầu cài đặt các gói cần thiết cho hệ điều hành..."
...
## Install nodejs 16
echo "Bắt đầu cài đặt nodejs v16...Nếu trình cài đặt bị đứng ở đây, vui lòng khởi động lại trình cài đặt gốc!"
cd ~
